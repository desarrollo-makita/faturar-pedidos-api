...
const { facturacionPedidos } = require('./../controllers/facturarPedidosControllers.js'); // Ajusta la ruta según tu estructura
const logger = require("../config/logger.js");

// Configurar el cron job para que se ejecute todos los días a las 3:00 AM
cron.schedule('12 12 * * *', async () => {
    logger.info('Iniciando tarea programada: facturacionPedidos');
    try {
